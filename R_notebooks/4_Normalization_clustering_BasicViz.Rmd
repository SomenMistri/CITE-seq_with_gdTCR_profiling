...
features1 <- c("Il17a","Il17f","Rorc","Blk","Maf")
features2 <- c("Ifng","Tbx21","Klrb1c", "Il2rb")
features3 <- c("Il4","Zbtb16","Icos")
...
p1 <-FeaturePlot(data_clust,
            features = "features1_1", label = FALSE, order = TRUE, min.cutoff = "q1", max.cutoff = "q99") +
            scale_colour_gradientn(colours = rev(brewer.pal(n = 11, name = "RdBu")))
p2 <-FeaturePlot(data_clust,
            features = "features2_1", label = FALSE, order = TRUE, min.cutoff = "q1", max.cutoff = "q99") +
            scale_colour_gradientn(colours = rev(brewer.pal(n = 11, name = "RdBu")))
p3 <-FeaturePlot(data_clust3,
            features = "features3_1", label = FALSE, order = TRUE, min.cutoff = "q1", max.cutoff = "q99") +
            scale_colour_gradientn(colours = rev(brewer.pal(n = 11, name = "RdBu")))
